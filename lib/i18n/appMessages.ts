...
const nl: AppMessages = {
  ...
  metadata: {
    ...
    language: "Taal",
    contentType: "Bericht type",
    contentTypeArticle: "Normaal artikel",
    contentTypePdf: "PDF",
...
const en: AppMessages = {
  ...
  userCredits: { ...nl.userCredits, adjustCredits: "Adjust credits", selfGuard: "You cannot adjust your own credits.", add: "Add", subtract: "Subtract", yearSubTitle: "Year subscription assignments", noYearSub: "No year subscriptions found.", therapistSubTitle: "Therapist directory subscription", noTherapistSub: "No therapist subscriptions found.", start: "Start", endLabel: "End", activeUntil: "Active until", renewedUntil: "Renewed until", indefinite: "indefinite", notScheduled: "not scheduled", status: "Status", free: "free", active: "active", planned: "planned", ended: "ended", directoryVisibility: "Visible in therapist directory", visibleInDirectory: "yes", hiddenInDirectory: "no", ending: "Ending...", endAction: "End", adjustFailed: "Adjusting credits failed", endFailed: "Ending subscription failed" },
  ...
  metadata: { ...nl.metadata, unsavedDeleteConfirm: "There are unsaved changes. Are you sure you want to delete this content?", deleteConfirm: "Are you sure you want to permanently delete this content?", publish: "Publish", saving: "Saving...", saveDraft: "Save draft", viewLive: "View live", editStatus: "edit", cancel: "Cancel", publishDate: "Publish date", creditCost: "Credit cost", update: "Update", publishAction: "Publish", moveToTrash: "Move to trash", permalink: "Permalink", noSlug: "(no-slug)", featuredImage: "Featured image", featuredImageAlt: "Featured image", altText: "Alt text", noFeatured: "No featured image selected yet.", change: "Change", choose: "Choose", delete: "Delete", close: "Close", categories: "Categories", noCategories: "No categories found.", noTags: "No tags found.", excerpt: "Excerpt", excerptPlaceholder: "Short summary like WordPress excerpt", accordionContent: "Accordion content", accordionDescription: "Add expandable sections that appear below the main content of this item.", addAccordionItem: "Add accordion item", accordionItemTitle: "Title", accordionItemTitlePlaceholder: "For example: Frequently asked questions", accordionEmpty: "No accordion items added yet.", removeAccordionItem: "Remove item", settings: "Settings", language: "Language", contentType: "Post type", contentTypeArticle: "Standard article", contentTypePdf: "PDF", visibilityPublic: "Visibility: Public", unknownSaveError: "Unknown save error." },
...
const fr: AppMessages = {
  ...en,
  home: {
    title: "Bienvenue chez Pure Therapeutic ART",
    subtitle:
      "Découvrez des exercices et du contenu qui vous accompagnent pas à pas.",
  ...
  login: {
    ...
    firstName: "Prénom",
    lastName: "Nom",
    accountType: "Je m'inscris comme",
    accountTypeClient: "Utilisateur (client)",
    accountTypeTherapist: "Thérapeute",
    submit: "Se connecter",
    forgotPassword: "Mot de passe oublié ?",
    forgotTitle: "Réinitialiser le mot de passe",
    forgotIntro:
      "Saisissez votre adresse e-mail. Si un compte existe, nous envoyons un e-mail de récupération.",
    forgotSubmit: "Envoyer l'e-mail",
    forgotSent:
      "Si un compte existe pour cette adresse, un e-mail de récupération est en route.",
    forgotInvalidEmail: "Saisissez d'abord une adresse e-mail valide.",
    forgotFailed: "L'envoi de l'e-mail a échoué. Réessayez.",
    backToLogin: "Retour à la connexion",
    registerTitle: "Créer un compte",
    registerSubmit: "Créer un compte",
    registerSuccess: "Votre compte a été créé. Vous pouvez vous connecter.",
    registerFailed: "L'inscription a échoué. Vérifiez vos données.",
    resetTitle: "Choisissez un nouveau mot de passe",
    resetIntro:
      "Définissez un nouveau mot de passe pour votre compte.",
    resetLoading: "Vérification du lien...",
    ...
    resetSubmitBusy: "Enregistrement...",
    resetSuccess: "Votre mot de passe a été mis à jour.",
  },
  accountPage: {
    title: "Mon compte",
    subtitle: "Gérez votre profil, vos crédits et vos contenus débloqués.",
  },
  accountTabs: {
    ...en.accountTabs,
    overview: "Aperçu",
    ...
    unlockedItems: "Éléments débloqués",
  ...
  userGeneral: {
    ...
    therapistDetails: "Détails du thérapeute",
    publicDirectory: "Afficher dans l'annuaire",
    publicDirectoryHint:
      "Activez ceci si les clients peuvent voir votre profil public.",
  ...
  lockedView: {
    ...en.lockedView,
    askAccess: "Voulez-vous accéder à ce contenu ?",
    buyCredits: "Acheter des crédits",
    unlockNow: "Débloquer",
    loginToUnlock: "Connectez-vous pour débloquer",
    unlocking: "Déblocage...",
  },
  creditOverview: { available: "Crédits disponibles" },
  creditTransactions: {
    ...en.creditTransactions,
    title: "Transactions",
...
const es: AppMessages = {
  ...fr,
  home: {
    title: "Bienvenido a Pure Therapeutic ART",
    subtitle:
      "Descubre ejercicios y contenido que te apoyan paso a paso.",
  ...
  login: {
    ...
    forgotSubmit: "Enviar correo de recuperación",
    backToLogin: "Volver al inicio de sesión",
    registerTitle: "Crear cuenta",
    registerSubmit: "Crear cuenta",
    registerSuccess: "Tu cuenta ha sido creada. Ya puedes iniciar sesión.",
    registerFailed: "El registro falló. Comprueba tus datos.",
    resetTitle: "Elige una nueva contraseña",
    resetSubmit: "Guardar nueva contraseña",
    resetSubmitBusy: "Guardando...",
  },
  accountPage: {
    title: "Mi cuenta",
    subtitle: "Gestiona tu perfil, créditos y contenido desbloqueado.",
  },
  accountTabs: {
    ...fr.accountTabs,
    overview: "Resumen",
    ...
    unlockedItems: "Elementos desbloqueados",
  ...
  userGeneral: {
    ...
    accountTypeTherapist: "Terapeuta",
    contactInfo: "Datos de contacto",
    website: "Sitio web",
    aboutYou: "Sobre ti",
    therapistDetails: "Datos del terapeuta",
    publicDirectory: "Mostrar en el directorio",
...
const pt: AppMessages = {
  ...es,
  home: {
    title: "Bem-vindo ao Pure Therapeutic ART",
    subtitle:
      "Descubra exercícios e conteúdos que o apoiam passo a passo.",
  ...
  accountPage: {
    title: "A minha conta",
    subtitle: "Gerir perfil, créditos e conteúdos desbloqueados.",
  },
  accountProfile: {
    ...es.accountProfile,
    saved: "Perfil guardado.",
...
const it: AppMessages = {
  ...es,
  home: {
    title: "Benvenuto in Pure Therapeutic ART",
    subtitle:
      "Scopri esercizi e contenuti che ti accompagnano passo dopo passo.",
  ...
  accountPage: {
    ...
    subtitle: "Gestisci profilo, crediti e contenuti sbloccati.",
  },
  accountProfile: {
    ...es.accountProfile,
...
const ar: AppMessages = {
  ...en,
  home: {
    title: "مرحباً بك في Pure Therapeutic ART",
    subtitle: "اكتشف تمارين ومحتوى يدعمك خطوة بخطوة.",
  ...
  login: {
    ...
    modeRegister: "إنشاء حساب",
    email: "البريد الإلكتروني",
    password: "كلمة المرور",
    confirmPassword: "تأكيد كلمة المرور",
    firstName: "الاسم الأول",
    lastName: "اسم العائلة",
    accountType: "أسجل بصفتي",
    accountTypeClient: "مستخدم",
    accountTypeTherapist: "معالج",
    submit: "تسجيل الدخول",
    forgotPassword: "هل نسيت كلمة المرور؟",
    forgotTitle: "إعادة تعيين كلمة المرور",
    forgotSubmit: "إرسال بريد الاستعادة",
    backToLogin: "العودة إلى تسجيل الدخول",
    registerTitle: "إنشاء حساب",
    registerSubmit: "إنشاء حساب",
    registerSuccess: "تم إنشاء حسابك. يمكنك الآن تسجيل الدخول.",
    resetTitle: "اختر كلمة مرور جديدة",
    resetSubmit: "حفظ كلمة المرور",
    resetSubmitBusy: "جارٍ الحفظ...",
  },
  accountPage: {
    title: "حسابي",
    subtitle: "إدارة ملفك الشخصي وأرصدتك والمحتوى المفتوح.",
  },
  accountTabs: {
    ...en.accountTabs,
    overview: "نظرة عامة",
    profile: "تعديل الملف",
    credits: "أرصدة",
    unlocked: "محتوى مفتوح",
    accountType: "نوع الحساب",
    availableCredits: "الأرصدة المتاحة",
    unlockedItems: "العناصر المفتوحة",
    roleTherapist: "معالج",
    roleAdmin: "مسؤول",
    roleClient: "عميل",
    roleUser: "مستخدم",
  ...
  userHeader: { createdAt: "تم الإنشاء" },
  userTabs: {
    general: "عام",
    credits: "أرصدة",
    unlocked: "محتوى مفتوح",
  ...
  userGeneral: {
    ...
    accountTypeClient: "عميل",
    accountTypeTherapist: "معالج",
    contactInfo: "معلومات الاتصال",
    website: "الموقع",
    aboutYou: "نبذة عنك",
    therapistDetails: "تفاصيل المعالج",
    publicDirectory: "إظهار في الدليل",
  ...
  lockedView: {
    ...
    unlockNow: "فتح الآن",
    loginToUnlock: "سجّل الدخول للفتح",
