import { resolveRange, getCountries } from "@/lib/insights/queries";
...
export default async function PublishersCountriesPage({
  searchParams,
}: {
  ...
  const countries = await getCountries(range, 20);

  return (
    <section className="space-y-6">
      <RangeTabs basePath="/admin/insights/publishers/countries" value={rangeValue} />
