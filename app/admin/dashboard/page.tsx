  ...
  return (
    <div className="p-6 w-full">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Link className="rounded border bg-white p-4 hover:bg-gray-50" href={getAdminAreaUrl("/users")}>
          <h2 className="font-semibold">{t.users}</h2>
          <p className="mt-1 text-sm text-gray-600">{t.usersDesc}</p>
        </Link>
        <Link className="rounded border bg-white p-4 hover:bg-gray-50" href={getAdminAreaUrl("/administration")}>
          <h2 className="font-semibold">{t.administration}</h2>
          <p className="mt-1 text-sm text-gray-600">{t.administrationDesc}</p>
        </Link>
        <Link className="rounded border bg-white p-4 hover:bg-gray-50" href={getAdminAreaUrl("/content")}>
